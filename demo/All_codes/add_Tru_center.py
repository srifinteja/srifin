...
# village_details_path = r'C:\Users\Teja\Downloads\Vijval\Center_Detail_Latest.xlsx'
# Concatenate folder_path from config.py with the file name
village_details_path = f"{config.folder_path}\\Center_Detail_Latest.xlsx"
...
unmatched_codes = set(village_details_df['censuscode2011_right']) - set(census_to_tru_mapping.keys())
if unmatched_codes:
