...
# output_file_path = r"C:\Users\Teja\Downloads\Vijval\Center_detail_Latest8.xlsx"
output_file_path= f"{config.folder_path}\\Center_detail_Latest8.xlsx"
...
grouped_df = df.groupby('censuscode2011', as_index=False).agg({
    ...
    'rec_branch': merge_unique,
    'center_count': 'sum',
    'Active_center': merge_unique,
    'CGT1_center': merge_unique,
    'CGT2_center': merge_unique,
    'GRT_center': merge_unique,
    'INITIATED_center': merge_unique,
    'All_centers': merge_unique,
    'bcode': merge_unique,
    'Appl_count': 'sum',
    'CB_VERIFICATION_FAILED_Count': 'sum',
    'CBC_DONE_Count': 'sum',
    'CGT1_Count': 'sum',
    'CGT2_Count': 'sum',
    'GRT_Count': 'sum',
    'DISBURSED_Count': 'sum',
            ...
            # Merging unique Branch Names for the same censuscode2011
})
